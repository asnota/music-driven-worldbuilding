...
The BluePrint logic automatically assigns the available HDRIs to and array at a runtime and then retrieves each HDRI via array index.
...
* **Niagara** – audio-reactive particle systems
...
This project builds upon the original HDRI and music generation framework developed by Qi Li and Huilai Zhao:
